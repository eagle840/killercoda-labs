...
- [ ] 4. **Develop `step4.md`**: Implement a new final exercise that demonstrates how to generate embeddings for documents and persist them directly into a Chroma collection.
